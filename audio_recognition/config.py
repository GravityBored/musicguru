...
# 0 = unlimited. Every distinct track is checked and every confirmed miss is
# returned; a cap silently hid tracks, which is worse than a slower page.
WANTLIST_SCAN_CAP = _env_int("AR_WANTLIST_SCAN_CAP", 0)
WANTLIST_MAX = _env_int("AR_WANTLIST_MAX", 0)
